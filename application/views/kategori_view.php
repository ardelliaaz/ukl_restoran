    ...
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('index.php/kategori/tambah'); ?>" method="post">
			<div class="modal-body">
	        	<input type="text" class="form-control" placeholder="id" name="id_kat">
	      </div>
	      <div class="modal-body">
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('index.php/kategori/ubah'); ?>" method="post" enctype="multipart/form-data">
	      <div class="modal-body">
	        	...
	        	<input type="text" class="form-control" placeholder="Nama" name="ubah_nama_kategori" id="ubah_nama_kategori">
	      </div>
	      <div class="modal-footer">
	        <input type="submit" class="btn btn-primary" name="submit" value="SIMPAN">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
