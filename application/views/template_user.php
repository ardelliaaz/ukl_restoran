...
<html lang="en">
  <head>
    ...
    <link href="a<?= base_url();?>ssets/css/style-responsive.css" rel="stylesheet">
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?php echo base_url('index.php/login_user/logout'); ?>">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                 ...
                 <li class="mt"><a class="active" href="<?php echo base_url('index.php/dashboard_user'); ?>"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                 <li class="sub-menu"><a href="<?php echo base_url('index.php/menu_user'); ?>" > <i class="fa fa-tasks"></i> <span>Data Menu </span> </a>                  </li>
                 <li class="sub-menu"><a href="<?php echo base_url('index.php/transaksi'); ?>" > <i class="fa fa-tasks"></i> <span>Transaksi </span> </a>                  </li>
