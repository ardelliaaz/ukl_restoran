        ...
        <div class="card">
            <div class="body">
              <table class="table table-hover table-bordered datatable">
                  <thead>
                    <tr>
                        <th>NOMOR MEJA</th><th>NAMA PELANGGAN</th><th>TGL PEMBAYARAN</th><th>TOTAL BIAYA</th><th>TOTAL BAYAR</th><th>STATUS</th><th>VERFIKASI ADMIN</th><th>AKSI</th>
                    </tr>
                   </thead>
                   <tbody>
                    <?php 
                     $no=0;
                      foreach ($data_pembayaran as $bayar) {
                        $dt_admin=$this->user->detail_admin(@$bayar->id_admin);
                          $no++;
                          switch ($bayar->bulan) {
