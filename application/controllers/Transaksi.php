...
class Transaksi extends CI_Controller {
	...
	public function cari_menu()
	{
		if($this->session->userdata('logged_in') == TRUE){
			...
			if($this->transaksi_model->cari_menu() == TRUE)
			{
				redirect('transaksi/index');
			} else {
				$this->session->set_flashdata('notif', 'Data Masakan tidak ditemukan atau stok sudah habis!');
				redirect('transaksi/index');
			}
	...
	{
		if($this->session->userdata('logged_in') == TRUE){
			$data['main_view'] = 'detail_order_view';
	...
	public function get_detail_transaksi_by_id($id_cart)
	{
		if($this->session->userdata('logged_in') == TRUE){
